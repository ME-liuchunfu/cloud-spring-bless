package xin.spring.bless.cloud.bless.service.user;
...
@EnableJpaRepositories(basePackages = {"xin.spring.bless.cloud.bless.service.user.dao"})
@EntityScan(basePackages = {"xin.spring.bless.cloud.bless.service.user.entity"})
